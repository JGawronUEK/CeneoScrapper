...
For {pros_count} opinion lists of advantages is available.
For {cons_count} opinion lists of disadvantages is available.
Average score based on opinion stars is equal to {average_score:.1f}""")
